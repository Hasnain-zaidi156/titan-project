    ...
    <div>
      ...
      <div className="grid-3" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px', marginBottom: '24px' }}>
        <div className="content-card" style={{ display: 'flex', alignItems: 'center', gap: '20px', padding: '20px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '4px' }}>Yeh total students ki ginti dikhata hai.</div>
          </div>
        </div>
        ...
        <div className="content-card" style={{ display: 'flex', alignItems: 'center', gap: '20px', padding: '20px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '4px' }}>Yeh active trainers ki sankhya dikhata hai.</div>
          </div>
        </div>
        ...
        <div className="content-card" style={{ display: 'flex', alignItems: 'center', gap: '20px', padding: '20px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '4px' }}>Yeh aaj ki attendance ka percentage dikhata hai.</div>
          </div>
        </div>
        ...
        <div className="content-card" style={{ display: 'flex', alignItems: 'center', gap: '20px', padding: '20px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '4px' }}>Yeh pending approvals ki sankhya dikhata hai.</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid-2">
        <div className="content-card">
          <h3 style={{ marginBottom: '8px', fontWeight: 600, color: '#1e293b' }}>Quick System Links</h3>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginBottom: '12px' }}>Yeh section jaldi se important pages tak jane ke liye hoti hai.</div>
        ...
        <div className="content-card">
          <h3 style={{ marginBottom: '8px', fontWeight: 600, color: '#1e293b' }}>Recent Students Activity</h3>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginBottom: '12px' }}>Yeh section recent students ki activity aur status dikhati hai.</div>
